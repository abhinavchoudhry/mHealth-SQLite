...
class HammerCurlPage extends StatefulWidget {
  final String title;

  const HammerCurlPage({required this.title, Key? key}) : super(key: key);

  @override
  State<HammerCurlPage> createState() => _BicepCurlPageState();
}

class _BicepCurlPageState extends State<HammerCurlPage> {
