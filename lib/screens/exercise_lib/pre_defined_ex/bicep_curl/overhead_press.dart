...
class OverheadPressPage extends StatefulWidget {
  ...
  const OverheadPressPage({required this.title, Key? key}) : super(key: key);

  @override
  State<OverheadPressPage> createState() => _BicepCurlPageState();
}

class _BicepCurlPageState extends State<OverheadPressPage> {
