...
class TricepDipPage extends StatefulWidget {
  final String title;

  const TricepDipPage({required this.title, Key? key}) : super(key: key);

  @override
  State<TricepDipPage> createState() => _BicepCurlPageState();
}

class _BicepCurlPageState extends State<TricepDipPage> {
