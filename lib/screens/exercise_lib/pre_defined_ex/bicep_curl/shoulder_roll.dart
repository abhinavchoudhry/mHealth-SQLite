...
class ShoulderRollPage extends StatefulWidget {
  final String title;

  const ShoulderRollPage({required this.title, Key? key}) : super(key: key);

  @override
  State<ShoulderRollPage> createState() => _BicepCurlPageState();
}

class _BicepCurlPageState extends State<ShoulderRollPage> {
