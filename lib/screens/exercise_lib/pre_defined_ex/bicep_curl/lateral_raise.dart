...
class LateralRaisePage extends StatefulWidget {
  final String title;

  const LateralRaisePage({required this.title, Key? key}) : super(key: key);

  @override
  State<LateralRaisePage> createState() => _BicepCurlPageState();
}

class _BicepCurlPageState extends State<LateralRaisePage> {
