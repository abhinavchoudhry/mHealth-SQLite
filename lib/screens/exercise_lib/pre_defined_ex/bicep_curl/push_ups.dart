...
class PushUpPage extends StatefulWidget {
  ...
  const PushUpPage({required this.title, Key? key}) : super(key: key);

  @override
  State<PushUpPage> createState() => _BicepCurlPageState();
}

class _BicepCurlPageState extends State<PushUpPage> {
